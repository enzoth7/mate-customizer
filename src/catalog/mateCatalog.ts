...
const baseMateVariants: BaseMateVariant[] = [
  {
    ...
    model: "torpedo",
    name: "Clásico",
    image: `${CATALOG_PATH}/Torpedo Alpaca Cincelado al Lacre.png`,
    sourceProducts: ["Torpedo Alpaca Cincelado al Lacre"],
    isDefault: true,
  },
  ...
  { id: "torpedo-croco-pelo-reforzado", model: "torpedo", name: "Cuero croco con pelo · reforzado", image: `${CATALOG_PATH}/Torpedo Alpaca y Bronce Croco Pelos.png`, sourceProducts: ["Torpedo Alpaca y Bronce Croco Pelos"] },
  {
    ...
    model: "torpedo",
    name: "Cuero estampado",
    image: `${CATALOG_PATH}/Torpedo Cuero Estampado Alpaca Lisa.png`,
    sourceProducts: ["Torpedo Cuero Estampado Alpaca Lisa", "Torpedo Cuero Estampado Virola Alpaca Comun", "Torpedo Cuero Estampado Virola Alpaca Grande"],
  },
  {
...
const rimCompatibility: Record<string, { ids: string[]; defaultId: string }> = {
  ...
  "torpedo-cuero-croco": { ids: ["alpaca", "alpaca-grande"], defaultId: "alpaca" },
